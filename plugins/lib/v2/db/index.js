...
export default (axios) => {
  return {
    ...
    // designer.js
    fetchAvailableProducts: (query) => fetchAvailableProducts(axios, query),
    ...
    admin: {
      ...
      updateCustomizableProduct: (data) => updateCustomizableProduct(axios, data),
      ...
      updateShop: (data) => updateShop(axios, data),
    },
    // marketplace
    marketplace: {
