  ...
  <div>
    ...
    <div class="flex flex-col p-24 py-16 pt-6 container mx-auto px-4">
      <div class="flex justify-between lg:px-16 font-bold">
        ...
        <div>
          <nuxt-link class="text-primary hover:text-primary-lighter" to="/">SEE ALL ></nuxt-link>
        </div>
      </div>
      <div class="flex flex-wrap items-center justify-center">
        ...
        <div
          class="flex-shrink-0 m-6 relative overflow-hidden bg-teal-500 rounded-lg max-w-xs shadow-lg"
        >
          <svg
            class="absolute bottom-0 left-0 mb-8"
            viewBox="0 0 375 283"
