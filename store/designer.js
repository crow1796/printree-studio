...
const actions = {
  ...
  moveObjectPosition(context, { obj, newIndex }){
    ...
    let newObjects = context.state.selectedProducts[context.state.currentProductIndex].variants[context.state.currentVariantIndex].printable_area[context.getters.currentSide].objects
